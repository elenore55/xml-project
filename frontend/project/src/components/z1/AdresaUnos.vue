...
<script>
    export default {
        ...
        methods: {
            ...
            validateUlica() {
                this.valid.ulica = (this.ulica != '');
                this.updateAdresa();
            },
            validateBroj() {
                this.valid.broj = (this.broj != '' && this.broj != 0);
                this.updateAdresa();
            },
            validateMesto() {
                this.valid.mesto = (this.mesto != '');
                this.updateAdresa();
            },
            validatePostanskiBroj() {
                this.valid.postanskiBroj = (this.postanskiBroj != '' && this.postanskiBroj != 0);
                this.updateAdresa();
            },
            validateDrzava() {
                this.valid.drzava = (this.drzava != '');
                this.updateAdresa();
            },
            isValidInput() {
                this.validateUlica();
